...
type HubBridge = {
  ...
  deviceAllowed: (params: { fingerprint: string; profilePeerId: string }) => Promise<{ ok: boolean; profileId: string }>;
  getProfileBlob: (params: { profileId: string }) => Promise<{ json: string | null }>;
  mergeProfileBlob: (params: { profileId: string; json: string }) => Promise<{ json: string }>;
};
...
const api: HubBridge = {
  ...
  getProfileBlob: (params) => rpc.request.getProfileBlob(params),
  mergeProfileBlob: (params) => rpc.request.mergeProfileBlob(params),
};
