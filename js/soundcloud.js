...
export const SOUNDCLOUD_PLACEHOLDER =
  "data:image/svg+xml," + encodeURIComponent(
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80">'
    + '<rect width="80" height="80" rx="10" fill="#ff5500"/>'
    + '<g fill="#fff">'
    + '<rect x="18" y="40" width="6" height="22" rx="2"/>'
    + '<rect x="28" y="30" width="6" height="32" rx="2"/>'
    + '<rect x="38" y="22" width="6" height="40" rx="2"/>'
    + '<rect x="48" y="28" width="6" height="34" rx="2"/>'
    + '<rect x="58" y="36" width="6" height="26" rx="2"/>'
    + "</g></svg>"
  );
...
export function sanitizeSoundCloudThumb(url) {
  try {
    ...
    if (host.endsWith("sndcdn.com")) return u.href.slice(0, 400);
    if (host === "soundcloud.com" && /^\/images\/[^/]+\.(png|jpe?g|gif|webp)$/i.test(u.pathname)) {
